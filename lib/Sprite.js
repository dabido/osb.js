 ...
 * @return {Sprite}          the sprite itself
 */
Sprite.prototype.color = function (duration, r, g, b) {
    this.addToChain("C", 0, duration, [this.r, this.g, this.b, r, g, b]);
    this.r = r;
    this.g = g;
    this.b = b;
    return this;
 ...
 * @return {Sprite}          the sprite itself
 */
Sprite.prototype.parameter = function (duration, string) {
	this.addToChain("P", 0, duration, [string]);
	return this;
};
